...
?>
                                            <tr>
                                                <td>
                                                    <a href="<?=base_url() . 'petugas/detail_ajuan?d=' . $l->id_ajuan . '&s=' . hash('sha256', $l->created_at)?>"
                                            ...
                                            <div class="modal fade" id="editModal<?=$l->id_ajuan?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form class="form-horizontal"
                                                                action="<?php base_url()?>petugas/edit_ajuan/<?=$l->id_ajuan?>"
                                                                method="post">
        ...
        <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Form tambah data -->
                        <form class="form-horizontal" action="<?php base_url()?>petugas/add_ajuan" method="post">
                            <div class="form-group row">
        ...
        $(document).ready(function() {
            ...
            function hapusData(id) {
                $.ajax({
                    url: '<?=base_url()?>petugas/hapus_ajuan',
                    type: 'POST',
                    data: {
                        id: id
                    },
